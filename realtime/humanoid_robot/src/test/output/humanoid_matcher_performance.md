...
Generated: `2026-08-12T00:07:04.887124+00:00`

## Summary

- Catalog: 348 segments, 60 tracks, 411 motions (411 preflight-passed).
- Core match latency: median **2.208 ms**, p95 **9.290 ms**, p99 **34.702 ms**.
- Core throughput: **192.5 queries/s** over 1000 timed calls.
...
- Catalog load: 20.579 ms.
- Matcher initialization: 1.697 ms.
- Catalog feature arrays: 2.27 MiB.
- Matcher normalized indexes: 2.26 MiB.
- Process RSS after initialization: 87.18 MiB (delta 6.99 MiB).
...
- Waveform-to-match latency: median 1038.071 ms, p95 1111.582 ms.
- Gain-invariant top-1: 3/3 (100.0%) for 0.1x/0.5x/1x/2x.
...
Raw machine-readable results: `realtime/humanoid_robot/src/test/output/humanoid_matcher_performance.json`.
